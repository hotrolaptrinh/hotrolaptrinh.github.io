            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
                    ...
                    <div className="flex overflow-x-auto pb-2 md:pb-0 gap-2 w-full md:w-auto scrollbar-hide">
                        ...
                        <a
                            href="/products"
                            className="px-3 py-2.5 rounded-full bg-white border border-gray-200 text-gray-500 hover:text-indigo-600 flex items-center justify-center"
                        >
                            <Filter size={18} />
                        </a>
                    </div>
                ...
                <div className="mt-12 text-center">
                    <a
                        href="/products"
                        className="inline-flex px-8 py-3 bg-white border border-gray-300 text-gray-700 font-medium rounded-xl hover:bg-gray-50 transition-colors items-center gap-2 mx-auto"
                    >
