...
type ViewState = 'home' | 'product-detail' | 'all-products';
    ...
    <div className="min-h-screen bg-white font-sans text-gray-900">
      ...
      <main>
        {currentView === 'product-detail' && selectedProduct ? (
          ...
          <AllProducts onProductSelect={handleProductSelect} />
        ) : (
          <>
                  ...
                  <div className="text-center md:text-left">
                     ...
                     <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                        <button 
                          ...
                          className="bg-white text-indigo-900 px-6 py-3 rounded-xl font-bold hover:bg-gray-100 transition-colors"
                        >
                           Xem gói Combo
                        </button>
